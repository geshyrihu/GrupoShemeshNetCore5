...
//        Task<IEnumerable<WeeklyReport>> GetReport(PanelDto model);
...
//            _context = context;
//        }
//        public async Task<IEnumerable<WeeklyReport>> GetReport(PanelDto model)
//        {
//            List<WeeklyReport> listReport;
...
//            {
//                listReport = await _context.WeeklyReport.Include(x => x.ResponsibleArea).Include(x => x.Request).Where(x => x.Customer.Id == customer &&
